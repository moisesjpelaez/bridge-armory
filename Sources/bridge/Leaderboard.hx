...
class Leaderboard {
    ...
    public function setScore(?options:Any = null, ?callback:Bool->Void = null) {
    ...
    public function getScore(?options:Any = null, ?callback:(Bool, Int)->Void = null) {
    ...
    public function getEntries(?options:Any = null, ?callback:(Bool, Map<Any, TEntry>)->Void = null) {
    ...
    public function showNativePopup(?options:Any = null, ?callback:Bool->Void = null) {
